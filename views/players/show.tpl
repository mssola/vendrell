...
<div class="dialog">
    ...
    <div class="dialog-body">
        <form action="/players/{{.Id}}" method="POST" autocomplete="off" accept-charset="utf-8">
            <input class="text" type="text" name="name" placeholder="Nom" value="{{.Name}}" />
...
<div class="dialog">
    ...
    <div class="dialog-body">
        <form action="/players/{{.Id}}/delete" method="POST" autocomplete="off" accept-charset="utf-8">
            ...
            <input class="text" type="text" name="name" placeholder="Nom" />
            <input class="btn red-btn" type="submit" value="Borrar" />
            <div class="clearout"></div>
        </form>
    </div>
